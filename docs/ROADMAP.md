...
| 9 | Modèles de projet Kotlin et Java | 0.10.0 | À faire | `kotlin-jvm` et `java` complets et propres, `verify-templates.sh` (build réel des combinaisons), enrichissement de `docs/TEMPLATES.md` (paramètres propres aux modèles) |
